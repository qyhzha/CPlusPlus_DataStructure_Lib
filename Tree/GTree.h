...
public:
    ...
    bool insert(TreeNode<T>* node)
    {
        ...
        if(gnode != NULL)
        {
            ...
            else if((this->m_root != NULL) && (gnode->parent != NULL))
            {
                ...
                {
                    ret = false;
                    THROW_EXCEPTION(InvalidParameterException, "Paramer tree node have invalid parent tree node...");
                }
            }
            else
            {
    ...
    bool insert(const T& value, TreeNode<T>* parent)
    {
        ...
        {
            ret = false;
            THROW_EXCEPTION(NoEnoughMemoryException, "No enough memory to insert new tree node...");
        }
