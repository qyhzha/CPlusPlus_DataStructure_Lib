...
public:
    ...
    SharedPointer< LinkList<int> > getAdjacent(int i)
    {
    	LinkList<int>* ret = NULL;
    	
    	if( (i >= 0) && (i < vCount()) )
    	{
    		ret = new LinkList<int>();
			...
			{
				THROW_EXCEPTION(NoEnoughMemoryException, "No enough memory to create LinkList<int> Object...");
			}
		}
		else
		{
